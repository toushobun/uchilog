...
export function validateTransactionForm(
  ...
  const type = parseTransactionType(getText(formData, "type"));
  ...
  const offsetMinutes = parseTimeZoneOffsetMinutes(
    getText(formData, "timeZoneOffsetMinutes"),
  );
  ...
  const transactionAt = parseTransactionAt(
    getText(formData, "transactionAt"),
    offsetMinutes,
  );
  ...
  const merchantIdText = getText(formData, "merchantId");
  ...
  const noteText = getText(formData, "note");
