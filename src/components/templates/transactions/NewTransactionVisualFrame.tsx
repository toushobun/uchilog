...
export type NewTransactionVisualFrameProps = {
  children: ReactNode;
  fullBleed?: boolean;
};
...
const newTransactionVisualFrameScopeSx: SxProps<Theme> = {
  color: "text.primary",
...
const newTransactionVisualFrameFullBleedSx: SxProps<Theme> = {
